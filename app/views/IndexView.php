...
<html>
    ...
    <body>
        ...
        <span><!-- Blue line under h1 title --></span>
...
adipisicng ellt.</p>
            ...
            <div class ="box-signup--white">
                ...
                <form name ="signup" action="/hack/register/" method="POST">
                    <label class="box-signup__label-name">Name<font color="red">*</font></font></label>
        ...
        $(document).ready(function(){
            $(".box__button").click(function(){
                $('.box-login--white').animate({'marginLeft' : "-=430px"});
            }); });
            $(document).ready(function(){
                $(".box-second__button").click(function(){
                    $('.box-signup--white').animate({'marginLeft' : "+=430px"});
                    $('.box-login--white').animate({'marginLeft' : "+=430px"});
